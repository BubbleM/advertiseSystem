...
import com.mybean.data.UploadFile;
...
public class HandleUpload extends HttpServlet {
	...
	public void uploadFileMethod(HttpServletRequest request,
		...
		try {
			...
			File dir = new File("C:/Program Files/Apache Software Foundation/Tomcat 6.0/webapps/advertiseSystem/img");
			dir.mkdir();
			...
			random2.close();
			random.close();
			String uri = "jdbc:mysql://127.0.0.1:3306/e-commerce?useUnicode=true&characterEncoding=utf-8";
